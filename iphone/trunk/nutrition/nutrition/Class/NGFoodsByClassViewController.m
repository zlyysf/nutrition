//
//  NGFoodsByClassViewController.m
//  nutrition
//
...
@interface NGFoodsByClassViewController ()<UIAlertViewDelegate>//,NGSelectFoodAmountDelegate>
{
    BOOL isChinese;
}
@end

@implementation NGFoodsByClassViewController{
...
{
    NGFoodCell* cell =(NGFoodCell*)[tableView dequeueReusableCellWithIdentifier:@"FoodCell"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *foodAttr = [self.foodArray  objectAtIndex:indexPath.row];//[takenFoodIdsArray objectAtIndex:indexPath.row];
...
//{
////    [self.editDelegate changeToCombinationWithFoodId:foodId andAmount:changedValue];
...
//                [self.navigationController popViewControllerAnimated:NO];//连续弹两次不行
                
                [self.navigationController popToViewController:(UIViewController*)self.editDelegate animated:YES];

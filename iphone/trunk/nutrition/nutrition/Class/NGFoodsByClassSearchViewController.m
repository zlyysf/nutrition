//
//  NGFoodsByClassSearchViewController.m
//  nutrition
//
...
@interface NGFoodsByClassSearchViewController ()//<NGSelectFoodAmountDelegate>
{
    BOOL isfirstLoad;
    BOOL isChinese;
}
...
@implementation NGFoodsByClassSearchViewController
...
-(void)typeButtonTapped:(UIButton *)sender
{
    ...
    NGFoodsByClassViewController *dailyIntakeViewController = [storyboard instantiateViewControllerWithIdentifier:@"NGFoodsByClassViewController"];
    LZDataAccess *da = [LZDataAccess singleton];
    NSDictionary *translationItemInfo2LevelDict = [da getTranslationItemsDictionaryByType:TranslationItemType_FoodCnType];
    ...
    dailyIntakeViewController.editDelegate = self.editDelegate;

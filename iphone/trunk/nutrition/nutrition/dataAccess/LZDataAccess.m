...
//    [sqlStr appendString:@"SELECT F.* ,FL.[Lower_Limit(g)],FL.[Upper_Limit(g)],FL.normal_value,P.PicPath, "];
    [sqlStr appendString:@"SELECT F.*,CnCaption,CnType,classify ,FC.[Lower_Limit(g)],FC.[Upper_Limit(g)],FC.normal_value,FC.PicPath, SingleItemUnitName,SingleItemUnitWeight, "];
    [sqlStr appendString:@"\n D.["];

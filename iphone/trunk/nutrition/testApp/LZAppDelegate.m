...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[LZViewController alloc] initWithNibName:@"LZViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[LZViewController alloc] initWithNibName:@"LZViewController_iPad" bundle:nil];
    }

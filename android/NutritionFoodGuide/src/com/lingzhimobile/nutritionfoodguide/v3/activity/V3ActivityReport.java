...
public class V3ActivityReport extends V3BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Pair<String, String> recommentFood : recommentFoods){
            ...
            TextView foodNameTextView = (TextView) view.findViewById(R.id.foodNameTextView);
            TextView foodCountTextView = (TextView) view.findViewById(R.id.foodCountTextView);
        ...
        for (String disease : diseases){
            View view = LayoutInflater.from(this).inflate(R.layout.v3_disease_cell, null);
            TextView diseaseTextView = (TextView)view.findViewById(R.id.diseaseTextView);
            diseaseTextView.setText(disease);
            diseaseLinearLayout.addView(view);
        }

        attentions = new String[]{"1. 少吃熏制，腌制，富含硝酸盐的食品","2. 避免大量饮酒，吸烟","3. 充分睡眠","4. 多饮水，保持室内空气流通"};
        attentionLinearLayout = (LinearLayout) findViewById(R.id.attentionLinearLayout);

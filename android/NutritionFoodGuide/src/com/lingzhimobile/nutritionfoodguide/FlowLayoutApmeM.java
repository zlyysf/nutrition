...
public class FlowLayoutApmeM extends ViewGroup {
    ...
    public FlowLayoutApmeM(Context context) {
        super(context);

        this.readStyleParameters(context, null);
    }

    public FlowLayoutApmeM(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        this.readStyleParameters(context, attributeSet);
    }

    public FlowLayoutApmeM(Context context, AttributeSet attributeSet, int defStyle) {

...
public class FoodProvider extends ContentProvider {
	static final String LogTag = "FoodProvider";


    public static String AUTHORITY = "com.lingzhimobile.nutritionfoodguide.FoodProvider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "food", SEARCH_FOODS);
        matcher.addURI(AUTHORITY, "food/#", GET_FOOD);
        // to get suggestions...
    ...
    /**
     * Handles all the food searches and suggestion queries from the Search Manager.
     * When requesting a specific word, the uri alone is required.
     * When searching all of the food for matches, the selectionArgs argument must carry
